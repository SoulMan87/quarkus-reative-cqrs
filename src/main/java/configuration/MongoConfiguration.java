...
public class MongoConfiguration {
    ...
    private final static String AGGREGATE_ID = "aggregate_id";
    private final static Logger logger = Logger.getLogger (String.valueOf (MongoConfiguration.class));
    @Inject
